...
public class PrivateKey implements PrivateKeyable, javax.security.auth.Destroyable {
    ...
    private PrivateKey(final UnsignedByteArray value, final KeyType keyType) {
        ...
        Preconditions.checkArgument(value.length() == 32, "Byte values passed to this constructor must be 32 bytes long, with no prefix.");
        ...
        // <- Always copy to ensure immutability
