...
public class MpTokenIssuanceMutableFlags extends Flags {
     ...
     */
    public static final MpTokenIssuanceMutableFlags CAN_MUTATE_CAN_LOCK = new MpTokenIssuanceMutableFlags(0x00000002);

    /**
     * Indicates flag {@code lsfMPTRequireAuth} can be changed. Hex: {@code 0x00000004}.
     */
    public static final MpTokenIssuanceMutableFlags CAN_MUTATE_REQUIRE_AUTH = new MpTokenIssuanceMutableFlags(0x00000004);

    /**
     * Indicates flag {@code lsfMPTCanEscrow} can be changed. Hex: {@code 0x00000008}.
     */
    public static final MpTokenIssuanceMutableFlags CAN_MUTATE_CAN_ESCROW = new MpTokenIssuanceMutableFlags(0x00000008);

    /**
     * Indicates flag {@code lsfMPTCanTrade} can be changed. Hex: {@code 0x00000010}.
     */
    public static final MpTokenIssuanceMutableFlags CAN_MUTATE_CAN_TRADE = new MpTokenIssuanceMutableFlags(0x00000010);

    /**
     * Indicates flag {@code lsfMPTCanTransfer} can be changed. Hex: {@code 0x00000020}.
     */
    public static final MpTokenIssuanceMutableFlags CAN_MUTATE_CAN_TRANSFER = new MpTokenIssuanceMutableFlags(0x00000020);

    /**
     * Indicates flag {@code lsfMPTCanClawback} can be changed. Hex: {@code 0x00000040}.
     */
    public static final MpTokenIssuanceMutableFlags CAN_MUTATE_CAN_CLAWBACK = new MpTokenIssuanceMutableFlags(0x00000040);

    /**
     * Allows field {@code MPTokenMetadata} to be modified. Hex: {@code 0x00010000}.
     */
    public static final MpTokenIssuanceMutableFlags CAN_MUTATE_METADATA = new MpTokenIssuanceMutableFlags(0x00010000);

    /**
     * Allows field {@code TransferFee} to be modified. Hex: {@code 0x00020000}.
     */
    public static final MpTokenIssuanceMutableFlags CAN_MUTATE_TRANSFER_FEE = new MpTokenIssuanceMutableFlags(0x00020000);
    ...
    private static MpTokenIssuanceMutableFlags of(boolean lsmfMPTCanMutateCanLock, boolean lsmfMPTCanMutateRequireAuth, boolean lsmfMPTCanMutateCanEscrow, boolean lsmfMPTCanMutateCanTrade, boolean lsmfMPTCanMutateCanTransfer, boolean lsmfMPTCanMutateCanClawback, boolean lsmfMPTCanMutateMetadata, boolean lsmfMPTCanMutateTransferFee) {
        return new MpTokenIssuanceMutableFlags(Flags.of(lsmfMPTCanMutateCanLock ? CAN_MUTATE_CAN_LOCK : UNSET, lsmfMPTCanMutateRequireAuth ? CAN_MUTATE_REQUIRE_AUTH : UNSET, lsmfMPTCanMutateCanEscrow ? CAN_MUTATE_CAN_ESCROW : UNSET, lsmfMPTCanMutateCanTrade ? CAN_MUTATE_CAN_TRADE : UNSET, lsmfMPTCanMutateCanTransfer ? CAN_MUTATE_CAN_TRANSFER : UNSET, lsmfMPTCanMutateCanClawback ? CAN_MUTATE_CAN_CLAWBACK : UNSET, lsmfMPTCanMutateMetadata ? CAN_MUTATE_METADATA : UNSET, lsmfMPTCanMutateTransferFee ? CAN_MUTATE_TRANSFER_FEE : UNSET).getValue());
    }
