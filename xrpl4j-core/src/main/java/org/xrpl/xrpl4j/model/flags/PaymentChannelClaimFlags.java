...
public class PaymentChannelClaimFlags extends TransactionFlags {
     ...
     */
    public static final PaymentChannelClaimFlags INNER_BATCH_TXN = new PaymentChannelClaimFlags(TransactionFlags.INNER_BATCH_TXN.getValue());
    ...
    private static PaymentChannelClaimFlags of(boolean tfFullyCanonicalSig, boolean tfRenew, boolean tfClose, boolean tfInnerBatchTxn) {
        return new PaymentChannelClaimFlags(TransactionFlags.of(tfFullyCanonicalSig ? TransactionFlags.FULLY_CANONICAL_SIG : UNSET, tfRenew ? RENEW : UNSET, tfClose ? CLOSE : UNSET, tfInnerBatchTxn ? INNER_BATCH_TXN : UNSET).getValue());
    }
