...
/**
 * The result of a {@code vault_info} rippled API method call.
 *
 * <p>This class will be marked {@link Beta} until the SingleAssetVault amendment is enabled on mainnet. Its API is
 * subject to change.</p>
 */
@Value.Immutable
@JsonSerialize(as = ImmutableVaultInfoResult.class)
@JsonDeserialize(as = ImmutableVaultInfoResult.class)
@Beta
public interface VaultInfoResult extends XrplResult {

    /**
     * Construct a {@code VaultInfoResult} builder.
     *
     * @return An {@link ImmutableVaultInfoResult.Builder}.
     */
    static ImmutableVaultInfoResult.Builder builder() {
