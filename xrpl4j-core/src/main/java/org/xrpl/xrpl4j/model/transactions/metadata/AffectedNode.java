...
public interface AffectedNode {
     ...
     */
    default <T extends MetaLedgerObject> void handle(final Consumer<CreatedNode<T>> createdNodeConsumer, final Consumer<ModifiedNode<T>> modifiedNodeConsumer, final Consumer<DeletedNode<T>> deletedNodeConsumer) {
     ...
     */
    default <T extends MetaLedgerObject, R> R map(final Function<CreatedNode<T>, R> createdNodeMapper, final Function<ModifiedNode<T>, R> modifiedNodeMapper, final Function<DeletedNode<T>, R> deletedNodeMapper) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
