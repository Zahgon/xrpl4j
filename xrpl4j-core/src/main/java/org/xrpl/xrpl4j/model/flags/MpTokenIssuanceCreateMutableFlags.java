...
public class MpTokenIssuanceCreateMutableFlags extends Flags {
     ...
     */
    public static final MpTokenIssuanceCreateMutableFlags CAN_MUTATE_CAN_LOCK = new MpTokenIssuanceCreateMutableFlags(0x00000002);

    /**
     * Indicates flag {@code lsfMPTRequireAuth} can be changed. Hex: {@code 0x00000004}.
     */
    public static final MpTokenIssuanceCreateMutableFlags CAN_MUTATE_REQUIRE_AUTH = new MpTokenIssuanceCreateMutableFlags(0x00000004);

    /**
     * Indicates flag {@code lsfMPTCanEscrow} can be changed. Hex: {@code 0x00000008}.
     */
    public static final MpTokenIssuanceCreateMutableFlags CAN_MUTATE_CAN_ESCROW = new MpTokenIssuanceCreateMutableFlags(0x00000008);

    /**
     * Indicates flag {@code lsfMPTCanTrade} can be changed. Hex: {@code 0x00000010}.
     */
    public static final MpTokenIssuanceCreateMutableFlags CAN_MUTATE_CAN_TRADE = new MpTokenIssuanceCreateMutableFlags(0x00000010);

    /**
     * Indicates flag {@code lsfMPTCanTransfer} can be changed. Hex: {@code 0x00000020}.
     */
    public static final MpTokenIssuanceCreateMutableFlags CAN_MUTATE_CAN_TRANSFER = new MpTokenIssuanceCreateMutableFlags(0x00000020);

    /**
     * Indicates flag {@code lsfMPTCanClawback} can be changed. Hex: {@code 0x00000040}.
     */
    public static final MpTokenIssuanceCreateMutableFlags CAN_MUTATE_CAN_CLAWBACK = new MpTokenIssuanceCreateMutableFlags(0x00000040);

    /**
     * Allows field {@code MPTokenMetadata} to be modified. Hex: {@code 0x00010000}.
     */
    public static final MpTokenIssuanceCreateMutableFlags CAN_MUTATE_METADATA = new MpTokenIssuanceCreateMutableFlags(0x00010000);

    /**
     * Allows field {@code TransferFee} to be modified. Hex: {@code 0x00020000}.
     */
    public static final MpTokenIssuanceCreateMutableFlags CAN_MUTATE_TRANSFER_FEE = new MpTokenIssuanceCreateMutableFlags(0x00020000);
     ...
     */
    public static final long VALID_MASK = CAN_MUTATE_CAN_LOCK.getValue() | CAN_MUTATE_REQUIRE_AUTH.getValue() | CAN_MUTATE_CAN_ESCROW.getValue() | CAN_MUTATE_CAN_TRADE.getValue() | CAN_MUTATE_CAN_TRANSFER.getValue() | CAN_MUTATE_CAN_CLAWBACK.getValue() | CAN_MUTATE_METADATA.getValue() | CAN_MUTATE_TRANSFER_FEE.getValue();
    ...
    private static MpTokenIssuanceCreateMutableFlags of(boolean tmfMPTCanMutateCanLock, boolean tmfMPTCanMutateRequireAuth, boolean tmfMPTCanMutateCanEscrow, boolean tmfMPTCanMutateCanTrade, boolean tmfMPTCanMutateCanTransfer, boolean tmfMPTCanMutateCanClawback, boolean tmfMPTCanMutateMetadata, boolean tmfMPTCanMutateTransferFee) {
        return new MpTokenIssuanceCreateMutableFlags(Flags.of(tmfMPTCanMutateCanLock ? CAN_MUTATE_CAN_LOCK : UNSET, tmfMPTCanMutateRequireAuth ? CAN_MUTATE_REQUIRE_AUTH : UNSET, tmfMPTCanMutateCanEscrow ? CAN_MUTATE_CAN_ESCROW : UNSET, tmfMPTCanMutateCanTrade ? CAN_MUTATE_CAN_TRADE : UNSET, tmfMPTCanMutateCanTransfer ? CAN_MUTATE_CAN_TRANSFER : UNSET, tmfMPTCanMutateCanClawback ? CAN_MUTATE_CAN_CLAWBACK : UNSET, tmfMPTCanMutateMetadata ? CAN_MUTATE_METADATA : UNSET, tmfMPTCanMutateTransferFee ? CAN_MUTATE_TRANSFER_FEE : UNSET).getValue());
    }
