...
public interface Issue {
     ...
     */
    default void handle(final Consumer<XrpIssue> xrpIssueHandler, final Consumer<IouIssue> iouIssueHandler, final Consumer<MptIssue> mptIssueHandler) {
     ...
     */
    default <R> R map(final Function<XrpIssue, R> xrpIssueMapper, final Function<IouIssue, R> iouIssueMapper, final Function<MptIssue, R> mptIssueMapper) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
