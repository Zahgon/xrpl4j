...
public interface LedgerSpecifier {
     ...
     */
    LedgerSpecifier VALIDATED = ImmutableLedgerSpecifier.builder().ledgerIndexShortcut(LedgerIndexShortcut.VALIDATED).build();

    /**
     * Request information about for the most recent ledger that has been validated by consensus.
     */
    LedgerSpecifier CURRENT = ImmutableLedgerSpecifier.builder().ledgerIndexShortcut(LedgerIndexShortcut.CURRENT).build();

    /**
     * Request information about the most recent ledger that has been closed for modifications and proposed for
     * validation.
     */
    LedgerSpecifier CLOSED = ImmutableLedgerSpecifier.builder().ledgerIndexShortcut(LedgerIndexShortcut.CLOSED).build();
     ...
     */
    @Value.Auxiliary
    default void handle(final Consumer<Hash256> ledgerHashHandler, final Consumer<LedgerIndex> ledgerIndexHandler, final Consumer<LedgerIndexShortcut> ledgerIndexShortcutHandler) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Value.Auxiliary
    default <R> R map(final Function<Hash256, R> ledgerHashMapper, final Function<LedgerIndex, R> ledgerIndexMapper, final Function<LedgerIndexShortcut, R> ledgerIndexShortcutMapper) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
