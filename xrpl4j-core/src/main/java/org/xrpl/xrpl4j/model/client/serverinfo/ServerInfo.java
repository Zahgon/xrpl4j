...
public interface ServerInfo {
     ...
     */
    default void handle(final Consumer<RippledServerInfo> rippledServerInfoHandler, final Consumer<ClioServerInfo> clioServerInfoHandler, final Consumer<ReportingModeServerInfo> reportingModeServerInfoHandler) {
     ...
     */
    default <R> R map(final Function<RippledServerInfo, R> rippledServerInfoMapper, final Function<ClioServerInfo, R> clioServerInfoMapper, final Function<ReportingModeServerInfo, R> reportingModeServerInfoMapper) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
