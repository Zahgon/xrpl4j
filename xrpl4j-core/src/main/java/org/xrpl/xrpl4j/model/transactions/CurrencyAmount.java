...
public interface CurrencyAmount {
     ...
     */
    default void handle(final Consumer<XrpCurrencyAmount> xrpCurrencyAmountHandler, final Consumer<IssuedCurrencyAmount> issuedCurrencyAmountConsumer, final Consumer<MptCurrencyAmount> mptCurrencyAmountConsumer) {
     ...
     */
    default <R> R map(final Function<XrpCurrencyAmount, R> xrpCurrencyAmountMapper, final Function<IssuedCurrencyAmount, R> issuedCurrencyAmountMapper, final Function<MptCurrencyAmount, R> mptCurrencyAmountMapper) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
