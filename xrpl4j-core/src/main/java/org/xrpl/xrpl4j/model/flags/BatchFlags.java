...
public class BatchFlags extends TransactionFlags {
     ...
     */
    private static BatchFlags of(boolean tfFullyCanonicalSig, boolean tfAllOrNothing, boolean tfOnlyOne, boolean tfUntilFailure, boolean tfIndependent) {
        return new BatchFlags(of(tfFullyCanonicalSig ? TransactionFlags.FULLY_CANONICAL_SIG : UNSET, tfAllOrNothing ? TransactionFlags.FULLY_CANONICAL_SIG : UNSET, tfOnlyOne ? ONLY_ONE : UNSET, tfUntilFailure ? UNTIL_FAILURE : UNSET, tfIndependent ? INDEPENDENT : UNSET).getValue());
    }
