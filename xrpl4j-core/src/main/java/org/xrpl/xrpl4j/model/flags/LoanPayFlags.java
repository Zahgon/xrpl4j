...
public class LoanPayFlags extends TransactionFlags {
    ...
    private static LoanPayFlags of(boolean tfFullyCanonicalSig, boolean tfLoanOverpayment, boolean tfLoanFullPayment, boolean tfLoanLatePayment) {
        long value = Flags.of(tfFullyCanonicalSig ? TransactionFlags.FULLY_CANONICAL_SIG : UNSET, tfLoanOverpayment ? LOAN_OVERPAYMENT : UNSET, tfLoanFullPayment ? LOAN_FULL_PAYMENT : UNSET, tfLoanLatePayment ? LOAN_LATE_PAYMENT : UNSET).getValue();
