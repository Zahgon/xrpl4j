 ...
 * {@link EscrowCreate} transaction creates an {@link MetaEscrowObject} in the ledger. A successful
 ...
 * {@link MetaEscrowObject} has a {@link MetaEscrowObject#finishAfter()} time, the held payment can only execute after
 * that time.
 *
...
public interface MetaEscrowObject extends MetaLedgerObject {
    ...
    /**
     * The transfer rate or transfer fee that was locked at escrow creation time. This field is present only for IOU or
     * MPT escrows (not XRP escrows).
     *
