...
public class XrplClient {
    ...
    public XrplClient(HttpUrl rippledUrl, Duration connectTimeout, Duration readTimeout) {
        this(JsonRpcClient.construct(rippledUrl, new Options(connectTimeout.toMillis(), TimeUnit.MILLISECONDS, readTimeout.toMillis(), TimeUnit.MILLISECONDS, true)));
    }
     ...
     */
    public <T extends Transaction> SubmitResult<T> submit(final SingleSignedTransaction<T> signedTransaction) throws JsonRpcClientErrorException, JsonProcessingException {
     ...
     */
    protected Optional<? extends TransactionResult<? extends Transaction>> getValidatedTransaction(final Hash256 transactionHash) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    protected boolean ledgerGapsExistBetween(final UnsignedLong submittedLedgerSequence, UnsignedLong lastLedgerSequence) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * @throws JsonRpcClientErrorException If {@code jsonRpcClient} throws an error.
     */
    public <T extends Transaction> TransactionResult<T> transaction(final TransactionRequestParams params, final Class<T> transactionType) throws JsonRpcClientErrorException {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Beta
    public VaultInfoResult vaultInfo(VaultInfoRequestParams params) throws JsonRpcClientErrorException {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
